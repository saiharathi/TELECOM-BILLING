...
{
    public partial class Call2 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Label10.Text = Session["status"].ToString();
        ...
        protected void StartClick(object sender, ImageClickEventArgs e)
        {
            a = 1;
