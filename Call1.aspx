<%@ Page Language="C#" AutoEventWireup="true"  CodeBehind="Call1.aspx.cs" Inherits="TBSProject.Customer.Call1" %>
	...
	<div class="timer">
        ...
        <div>
          ...
          <asp:Label ID="Label5" runat="server" Font-Size="X-Large" Visible="false" ></asp:Label>
              ...
              <asp:Label ID="Label10" runat="server" Visible="false" Text="CallStatus"></asp:Label>
        ...
        <asp:UpdatePanel runat="server" id="UpdatePanel">
            ...
            <ContentTemplate>
                ...
                <asp:ImageButton ID="ImageButton1" runat="server" Height="39px" ImageUrl="~/Images/call.png" Width="48px" OnClick="Localstart_click" />
                <asp:ImageButton ID="ImageButton2" runat="server" Height="40px" ImageUrl="~/Images/End.png" Width="48px" OnClick="LocalEnd_call" />
          </form>
